...
import ImageOrders from "@/images/abcart-images/orders.jpg";
...
const OrdersPage = async () => {
  ...
  return (
    <div className="bg-pink-50  min-h-screen pb-8">
        <Image src={ImageOrders} alt="Orders" className="w-full h-96 object-fit object-center" />
      <Container className="py-10">
        {orders?.length ? (
          ...
          <div className="flex flex-col items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
            <ShieldX  className="h-24 w-24 text-gray-400 mb-4" />
