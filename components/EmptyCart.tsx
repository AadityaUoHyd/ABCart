  ...
  return (
    <div className="bg-white flex items-center justify-center py-20">
      ...
      >
        ...
        <Link
          href="/"
          className="inline-block bg-pink-500 text-white font-semibold px-6 py-3 rounded-lg transition-colors duration-300 hover:bg-green-800 focus:outline-none focus:ring-2 focus:ring-pink-500 focus:ring-offset-2"
        >
          Start Shopping
        </Link>
      </motion.div>
